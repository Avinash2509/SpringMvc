...
<!-- Theme style -->
<link href='<spring:url value="/resources/dist/css/AdminLTE.css"/>'
	rel="stylesheet" />
...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<%
				ArrayList<User> nameList = (ArrayList<User>) request.getAttribute("lists");
			%>
			<!-- Main content -->
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<tr>
										...
										<td><a
											href="updateuser?id=<% out.println(name.getId());%>"><span
												class="label label-primary" data-toggle="tooltip"
												data-placement="top" title="Click to update">Update</span></a></td>
										<td><a
											href="deleteUser?id=<% out.println(name.getId());%>"><span
												class="label label-danger" data-toggle="tooltip"
												data-placement="top" title="Click to Delete">Delete</span></a></td>
