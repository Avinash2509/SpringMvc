      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="userspage"><i class="fa fa-user"></i> <span>Users</span></a></li>
                ...
                <form class="form-horizontal" action="update" method="post" > 
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="username" name="username" value="<%user.getUsername(); %>" type="text">
                      </div>
                    </div>  
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="mobile"name="mobile" value="<%user.getMobile(); %>" type="number">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-3 control-label">email</label>
                      <div class="col-sm-4">
                        <input class="form-control" required id="email" name="email" value="<%user.getEmail(); %>" type="text">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" required id="password" name="password" value="<%user.getPassword(); %>" type="password">
                         <input type="hidden" name="id" value="<%user.getPassword(); %>" >
                      </div>
                    </div>
                  <%
                  ...
                  <input type="submit" name="submit" value="Submit"  class="btn btn-info pull-right" style="margin-left:5px;width:150px;">
                    <!--  button type="submit" id="submit" class="btn btn-info pull-right" style="margin-left:5px;width:150px;">Submit</button>-->
                    <a href="userspage"><span class="btn btn-default pull-right" style="width:150px;">Cancel</span></a>                   
                  </div><!-- /.box-footer -->
                </form>
                <!-- /c:forEach> -->
              </div><!-- /.box -->
